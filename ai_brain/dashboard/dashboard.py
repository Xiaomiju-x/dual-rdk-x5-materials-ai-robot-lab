...
<title>🎲 对赌盲抽墙 · XRD Smart Lab</title>
<style>
*{margin:0;padding:0;box-sizing:border-box}
...
async function main(){
  ...
  <div class="sub">XRD 智慧实验室 · 闭环优化 (GP/EI 贝叶斯主动学习) · 生成于 ${new Date().toLocaleString('zh-CN')} · ${c.cid}</div>
...
<div class="footer">
  XRD 智慧实验室 | 研磨 → 烧制 → XRD → PL → <span>配方决策</span> | 2026 嵌入式竞赛
</div>
...
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Tanabe-Sugano 交互图 — XRD 智慧实验室</title>__CSS__
<style>
...
def engine_page():
    html = """<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>推理机房 — XRD 智慧实验室</title>__CSS__
<style>
...
def compare_page():
    html = """<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>预测对比台 — XRD 智慧实验室</title>__CSS__
<style>
