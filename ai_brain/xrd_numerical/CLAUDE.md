# 基于双 RDK X5 异构协同的材料合成 AI 预测与多机具身实验助理机器人｜XRD 数值线项目指南

> **状态: AI 脑冻结于 2026-04-19**, 不再做大改动. 顶层最新状态见 [AI 脑公开导航](../../docs/modules/AI_BRAIN.md).

## 项目定位

> 面向嵌入式 AI 芯片的 XRD 智能分析系统——用物理定律验证判断，用拓扑数学检测异常，用 AI Agent 辅助规划实验
...
- **TDA持久同调**: 纯 NumPy H₀ Vietoris-Rips，用于实验性拓扑 XRD 分类
