...
def build_sbom(root: Path) -> dict[str, Any]:
    ...
    project_package: dict[str, Any] = {
        "name": "XRD Smart Lab",
        "SPDXID": PROJECT_ID,
        "downloadLocation": "https://github.com/Xiaomiju-x/xrd",
        "homepage": "https://github.com/Xiaomiju-x/xrd",
        "filesAnalyzed": False,
    ...
    frontend_package: dict[str, Any] = {
        "name": frontend_name,
        "SPDXID": FRONTEND_ID,
        "downloadLocation": "https://github.com/Xiaomiju-x/xrd/tree/main/workstation_frontend_public",
        "filesAnalyzed": False,
        "licenseConcluded": "NOASSERTION",
    ...
    return {
        ...
        "documentNamespace": (
            "https://github.com/Xiaomiju-x/xrd/sbom/spdx-2.3/" + input_digest
        ),
        "creationInfo": {
            "created": CREATED_AT,
            "creators": [
